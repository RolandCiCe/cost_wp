...
<section>
  <div class="">
    <div class="negro">
      <img src="<?php echo get_template_directory_uri().'/img/quienes_somos/aseguramiento/blanco_aseguramiento.png' ; ?>" alt="" />
    </div>
...
<section>
  <div class="">
    <img src="<?php echo get_template_directory_uri().'/img/quienes_somos/aseguramiento/imag_etapas.png' ; ?>" alt="" />
  </div>
</section>
