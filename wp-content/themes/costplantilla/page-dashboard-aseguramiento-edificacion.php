...
<div class="contenido-hero single-header aseg aseg-edif" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);">
  <h1><?php echo the_field('titulo_edificacion'); ?></h1>
</div><br />
