...
<div class="contenido-hero single-header aseg aseg-trans" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);">
  <h1><?php echo the_field('titulo_transporte'); ?></h1>
</div><br />
