...
<?php while(have_posts()): the_post(); ?>
    <div class="contenido-hero single-header eventos-capacitaciones" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);">
