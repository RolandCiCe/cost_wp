...
<div class="contenido-hero single-header proyectos-aprobados" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);">
</div><br />
...
<section class="eventos">
  <div class="events-list container-fluid">
    ...
    $query = new WP_Query( array(
        'category_name' => 'ProyectosAprobados',
        'paged' => $paged
    ) );
